...
import { Button, filter, Flex, Icon, Popover, PopoverArrow, PopoverBody, PopoverCloseButton, PopoverContent, PopoverHeader, PopoverTrigger, Text, VStack } from '@chakra-ui/react'
import FilterIcon from './icons/FilterIcon'
import { STATUSES } from '../data'
import { ColorIcon } from './StatusCell'

const StatusItem = ({ status, setColumnFilters, isActive }) => <Flex
  align='center'
  cursor='pointer'
  borderRadius={5}
  fontWeight='bold'
    ...
    <Popover isLazy>
      <PopoverTrigger>
        <Button 
          size='sm' 
          leftIcon={
            <Icon as={FilterIcon} fontSize={18} />
          }
        >Filter</Button>
      </PopoverTrigger>
      <PopoverContent>
